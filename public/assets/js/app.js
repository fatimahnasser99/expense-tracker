...
function updateWallet() {
  ...
  for (var index = 0; index < size; index++) {
    if (amount[index] > 0) income += amount[index];
    if (amount[index] < 0) expense += amount[index];
  }
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkexpense_tracker"] = self["webpackChunkexpense_tracker"] || [];
